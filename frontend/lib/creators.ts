...
export const TRENDING: { id: string; title: string; creator: string; gradient: string }[] = [
  { id: "t1", title: "The Suit Economy", creator: "aria", gradient: "linear-gradient(160deg, #8a8a8f, #232329)" },
  { id: "t2", title: "Neon Kyoto", creator: "sakura", gradient: "linear-gradient(160deg, #c96f6f, #3a2228)" },
  { id: "t3", title: "Concrete Gardens", creator: "marcus", gradient: "linear-gradient(160deg, #5a5a5a, #111111)" },
  { id: "t4", title: "The Night Market Index", creator: "amara", gradient: "linear-gradient(160deg, #b98a5a, #2e2013)" },
  { id: "t5", title: "Objects in Repose", creator: "lin", gradient: "linear-gradient(160deg, #7a8a9a, #1f2730)" },
  { id: "t6", title: "Machines That Leave", creator: "oliver", gradient: "linear-gradient(160deg, #6a7a8a, #161b20)" },
];